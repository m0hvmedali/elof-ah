...
const gratitudeMessages = [
  "كل سنه وانت طيبة يحبيبتي",
  "بحبك",
  "بحبك يا بطة",
  "كل سنه وانت في حياتي",
  "Happy birthday cat women ",
  "مش بعرف أتكلم حلو، بس بعرف أحبك صح",
  "ربنا ما يحرمنيش من دماغك النسايه",
  "ولا من نغزاتي واحنا سوا ",
  "خسيتي يا بطه",
  "كدا لسنه الجايه هتبقي 55  كيلو "
